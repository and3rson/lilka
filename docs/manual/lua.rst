...
Для простих програм на Lua, які не вимагають точності в швидкості виконання, можна використовувати ``util.sleep(...)`` для затримки виконання програми. Однак це незручно для ігор.
...
.. warning::
   ...
   Крім того, не варто використовувати :lua:func:`util.sleep` у програмах, які використовують ``lilka._update()``, оскільки це призведе до заповільнення виконання програми.
