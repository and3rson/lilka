...
.. glossary::
   ...
   Git
    ...
    Весь код Лілки та Doom, всі креслення та навіть вся ця документація зберігаються саме в Git в `репозиторії на GitHub <https://github.com/lilka-dev/lilka>`_ і доступні для всіх бажаючих абсолютно безкоштовно.
