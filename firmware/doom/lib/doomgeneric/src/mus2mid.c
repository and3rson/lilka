...
static boolean32 WriteTime(unsigned int time, MEMFILE *midioutput)
{
...
static boolean32 WriteEndTrack(MEMFILE *midioutput)
{
...
static boolean32 WritePitchWheel(byte channel, short wheel,
                               MEMFILE *midioutput)
{
...
static boolean32 WriteChangePatch(byte channel, byte patch,
                                MEMFILE *midioutput)
{
...
static boolean32 WriteChangeController_Valued(byte channel,
                                            byte control,
                                            byte value,
                                            MEMFILE *midioutput)
{
...
static boolean32 WriteChangeController_Valueless(byte channel,
                                               byte control,
                                               MEMFILE *midioutput)
{
...
static boolean32 ReadMusHeader(MEMFILE *file, musheader *header)
{
    boolean32 result;
...
boolean32 mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 3)
    {
        DG_printf("Usage: %s <musfile> <midfile>\n", argv[0]);
        exit(-1);
    }
