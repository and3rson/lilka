...
// P_CheckMeleeRange
//
boolean32 P_CheckMeleeRange (mobj_t*	actor)
{
    mobj_t*	pl;
    fixed_t	dist;
...
// P_CheckMissileRange
//
boolean32 P_CheckMissileRange (mobj_t* actor)
{
    fixed_t	dist;
...
//
boolean32 P_TryWalk (mobj_t* actor)
{	
    if (!P_Move (actor))
    {
	return false;
...
boolean32 PIT_VileCheck (mobj_t*	thing)
{
    int		maxdist;
    boolean32	check;
...
static boolean32 CheckBossEnd(mobjtype_t motype)
{
