...
typedef struct
{
    ...
    boolean32 (*DrawScreen)(int x1, int y1, int x2, int y2);
    ...
    boolean32 poor_quality;
} screen_mode_t;

typedef boolean32 (*grabmouse_callback_t)(void);
...
extern boolean32 screenvisible;

extern float mouse_acceleration;
extern int mouse_threshold;
extern int vanilla_keyboard_mapping;
extern boolean32 screensaver_mode;
extern int usegamma;
