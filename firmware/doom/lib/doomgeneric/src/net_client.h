...
boolean32 NET_CL_Connect(net_addr_t *addr, net_connect_data_t *data);
...
boolean32 NET_CL_GetSettings(net_gamesettings_t *_settings);
void NET_Init(void);

void NET_BindVariables(void);

extern boolean32 net_client_connected;
extern boolean32 net_client_received_wait_data;
extern net_waitdata_t net_client_wait_data;
extern boolean32 net_waiting_for_launch;
