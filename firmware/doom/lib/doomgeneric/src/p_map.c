...
// PIT_StompThing
//
boolean32 PIT_StompThing (mobj_t* thing)
{
    fixed_t	blockdist;
...
//
boolean32 PIT_CheckLine (line_t* ld)
{
...
// PIT_CheckThing
//
boolean32 PIT_CheckThing (mobj_t* thing)
{
    fixed_t		blockdist;
    boolean32		solid;
    int			damage;
...
//
boolean32 P_ThingHeightClip (mobj_t* thing)
{
    boolean32		onfloor;
...
// PTR_SlideTraverse
//
boolean32 PTR_SlideTraverse (intercept_t* in)
{
    line_t*	li;
...
// PTR_ShootTraverse
//
boolean32 PTR_ShootTraverse (intercept_t* in)
{
    fixed_t		x;
    fixed_t		y;
    fixed_t		z;
...
boolean32	PTR_UseTraverse (intercept_t* in)
{
    int		side;
...
//
boolean32 PIT_RadiusAttack (mobj_t* thing)
{
    fixed_t	dx;
    fixed_t	dy;
    fixed_t	dist;
...
// PIT_ChangeSector
//
boolean32 PIT_ChangeSector (mobj_t*	thing)
{
    mobj_t*	mo;
