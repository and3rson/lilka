...
void drawTask(void* arg) {
    while (1) {
        ...
        lilka::display.setTextColor(lilka::display.color565(255, 255, 255), lilka::colors::RGB565_Black);
...
extern "C" void DG_printf(const char* format, ...) {
    ...
    if (hadNewLine) {
        hadNewLine = false;
        lilka::display.fillRect(0, bottom, 240, 280 - bottom, lilka::colors::RGB565_Black);
