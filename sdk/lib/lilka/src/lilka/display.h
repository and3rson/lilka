...
public:
    ...
    /// Увімкнути або вимкнути підсвітку.
    ///
    /// Цей метод дозволяє економити енергію, вимикаючи підсвітку дисплея, коли вона не потрібна - наприклад, при вході в режим сну.
    /// @param enabled `true`, щоб увімкнути підсвітку, або `false`, щоб вимкнути.
